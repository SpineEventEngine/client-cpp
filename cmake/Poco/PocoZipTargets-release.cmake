...
set_target_properties(Poco::Zip PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libPocoZip.50.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPocoZip.50.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Zip )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Zip "${_IMPORT_PREFIX}/lib/libPocoZip.50.dylib" )
